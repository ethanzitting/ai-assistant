...
- `search_archives` retrieves stored research from the vector index. Direct web search is disabled until isolated outbound fetching exists in the ingestion architecture.
